...
/*
*  ACF SKU Relationship Field Class
*
*  All the logic for this field type
*
*  @class      acf_field_sku_relationship
*  @extends    acf_field
*  @package    ACF
*  @subpackage Fields
*/

if (! class_exists('acf_field_sku_relationship')) :

class acf_field_sku_relationship extends acf_field
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        // vars
        $this->name = 'sku_relationship';
        $this->label = __("SKU Relationship", 'acf');
        ...
        // extra
        add_action('wp_ajax_acf/fields/sku_relationship/query', [$this, 'ajax_query']);
        add_action('wp_ajax_nopriv_acf/fields/sku_relationship/query', [$this, 'ajax_query']);
    ...
    */
    ...
    public function input_admin_enqueue_scripts()
    {
        ...
        // register & include JS
        wp_register_script('acf-input-sku_relationship', "{$dir}field.js");
        wp_enqueue_script('acf-input-sku_relationship');


        // register & include CSS
        wp_register_style('acf-input-sku_relationship', "{$dir}field.css");
        wp_enqueue_style('acf-input-sku_relationship');
    }
    ...
    */
    ...
    public function render_field($field)
    {
        ...
        $atts = array(
            'id'                => $field['id'],
            'class'                => "acf-sku_relationship {$field['class']}",
            'data-min'            => $field['min'],
            'data-max'            => $field['max'],
            'data-s'            => '',
            'data-post_type'    => '',
    ...
    */
    ...
    public function update_value($value, $post_id, $field)
    {
        ...
        foreach ($value as $id) {
            ...
            if ($_product->sku) {
                array_push($returnValue, $_product->sku);
            }
        }
...
new acf_field_sku_relationship();
